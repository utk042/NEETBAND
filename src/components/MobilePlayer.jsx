...
export default function MobilePlayer({ currentTrack, isPlaying, togglePlay, currentTime, onNext, favoritedTrackIds, onToggleFavorite }) {
  ...
  return (
    <div className="fixed bottom-20 left-0 w-full z-50 bg-background/85 backdrop-blur-md border-t border-[var(--border-nav-bar)] md:hidden shadow-[0_-8px_30px_rgba(0,0,0,0.04)] dark:shadow-[0_-8px_30px_rgba(0,0,0,0.2)] transition-all duration-300">
      {/* Progress Bar */}
