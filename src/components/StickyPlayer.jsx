...
export default function StickyPlayer({ currentTrack, isPlaying, togglePlay, currentTime, onNext, onPrev, onSeek, favoritedTrackIds, onToggleFavorite }) {
  ...
  return (
    <section className="fixed bottom-0 left-0 w-full z-[45] bg-surface/85 backdrop-blur-md border-t border-outline/20 hidden md:block shadow-[0_-8px_30px_rgba(0,0,0,0.04)] dark:shadow-[0_-8px_30px_rgba(0,0,0,0.2)] transition-all duration-300 fixed-bottom-safe">
      {/* Progress Scrubber */}
      <div 
        role="slider"
      ...
      <div className="max-w-container-max mx-auto px-gutter h-24 flex items-center justify-between">
        ...
        <div className="w-1/3 flex justify-end items-center gap-6">
          ...
          <button className="text-on-surface-variant hover:text-primary transition-colors p-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 rounded-full flex items-center justify-center" aria-label="Mute/Unmute">
