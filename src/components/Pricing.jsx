        ...
        <div data-gsap="pricing-grid" className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-4xl mx-auto items-stretch">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full justify-between items-stretch gap-8">
              ...
              <button className="w-full border border-outline/20 hover:border-primary text-on-surface font-label-md text-base py-4 rounded-xl transition-all bg-surface hover:bg-surface-container active:scale-[0.98] active:translate-y-[1px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50">
                Current Plan
              </button>
            </div>
          </div>
            ...
            <div className="relative z-10 flex flex-col h-full justify-between items-stretch gap-8">
              <div>
                <div className="text-center mb-8">
                  ...
                  <div className="font-display-lg text-[50px] md:text-[56px] text-on-surface">₹299 <span className="font-body-md text-base text-on-surface-variant font-normal">/ month</span></div>
                </div>
                <div className="w-fit mx-auto text-left">
                  <ul className="space-y-4">
